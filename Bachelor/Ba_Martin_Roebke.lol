...
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {3}The JSON format as an used to describe MSOL visualization on tree decompositions}{65}{lstlisting.3}%
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {4}Tree decomposition in DIMACS format for Figure \ref {fig:tdweelgraph7}}{67}{lstlisting.4}%
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {5}Initializing a Visualization object}{67}{lstlisting.5}%
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {6}SvgJoinData}{68}{lstlisting.6}%
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {7}IncidenceGraphData}{69}{lstlisting.7}%
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8}GeneralGraphData}{69}{lstlisting.8}%
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {9}Construct\_dpdb\_visu.py}{70}{lstlisting.9}%
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {10}forward\_iterate\_tdg}{70}{lstlisting.10}%
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {11}backwards\_iterate\_tdg}{71}{lstlisting.11}%
\defcounter {refsection}{0}\relax 
