...
\begin{figure}[h]
	...
	\end{tabularx}	
	\caption{Two templates from published project documentations which show similar visualizations as TDVisu. Left from \cite{DiplomarbeitZisser} figure 4.3 page 29 and the right graphic from \cite{dpdbpadl2020} figure 2, page 4.}
\end{figure}
