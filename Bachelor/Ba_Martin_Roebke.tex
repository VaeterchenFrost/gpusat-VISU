...
Outputs a dot graph~\cite{dotsalgorithm93} like for our example for \#SAT~\ref{lst:g41digraphdot} with the bags and respective solutions as nodes connected to the bag they solve.
