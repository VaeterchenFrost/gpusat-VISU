...
Some use cases include fields of interest like % (see also \url{neo4j.com/use-cases})
\begin{itemize}
...
File formats for these purposes were developed at "DIMACS" (the Center for Discrete Mathematics and Theoretical Computer Science) in 1993 at Rutgers University.
...
\begin{itemize}
	\item rankdir "TB", "LR", "BT", "RL", corresponding to directed graphs drawn from top to bottom, from left to right, from bottom to top, and from right to left, respectively. 
	\item fillcolor  \url{https://graphviz.org/doc/info/attrs.html#k:color} \url{https://graphviz.org/doc/info/colors.html} 
	...
	\item fontcolor Color used for text. 
	\item style for nodes \url{https://graphviz.org/doc/info/attrs.html#d:style}
	...
	\item 	fontsize Font size, in points, used for text. 
	\item penwidth Specifies the width of the pen, in points, used to draw lines and curves, including the boundaries of edges and clusters. 
	\item nodesep In dot, this specifies the minimum space between two adjacent nodes in the same rank, in inches. 
	\item shape https://graphviz.org/doc/info/shapes.html
\end{itemize}
