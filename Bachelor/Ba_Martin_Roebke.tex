...
\begin{itemize}
	\item centerpad: float = 0,
	\item v\_bottom: float = None,
	\item v\_top: float = None,
	\item scale2: float = 1,
\end{itemize}
allow very flexible and easy to use vertical, horizontal and scaling transformations.
