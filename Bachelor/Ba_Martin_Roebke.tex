...
\end{figure}
\begin{figure}[H]
	\centering Third step solving \textbf{bag 3}
	\includegraphics[width=0.9\linewidth]{images/WheelGraph7/combined4.pdf} \vspace{0.2em}\\
	Last step solving \textbf{bag 1} \vspace{0.5em}\\
