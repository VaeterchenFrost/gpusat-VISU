...
Inputs for solvers and in some cases for preparing the visualization of dpdb are expected to be in a DIMACS format. It exist several standardized formats for different cases, for example CNF clauses, graph edges and graph decomposition.
...
They are supported in math software such as \href{https://reference.wolfram.com/language/ref/format/DIMACS.html}{"Wolfram Language"} for storing a single undirected graph and maple .
...
%==============================================================================
\newpage
\section{Integration in dpdb - WIP}
