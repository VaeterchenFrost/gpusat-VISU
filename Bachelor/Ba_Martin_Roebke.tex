...
The objective of this thesis is to help improve the development efforts of dynamic programming on tree decompositions via visualization. The techniques 
...
And also some information on algorithm visualization and visual debugging from
\begin{itemize}
	...
	\item "ELVIZ: A query-based approach to model visualization" about methods to visualize the structure of trees that occur in genetic programming \cite{ELVIZ},
\end{itemize}
\cite{ELVIZ}
