...
\subsection{Summary}
We could create and for the most part automate visualization of dynamic programming on tree decompositions.
With SVG we support a human readable, highly adaptable data format.\\
...
The visualization got implemented and tested for two actively developed solvers and for the problem types \textbf{SAT}, \textbf{\#SAT} and \textbf{minimal vertex cover}.\\

During development we could already find some improvements in the solvers and easily identify possible bugs.
...
In the future the visualization could provide even more options to the user. \\

Even different colors visualizing attributes of each node would be a consideration.\\
