...
The visualization output consists by default of scalable-vector-graphics \href{https://developer.mozilla.org/en-US/docs/Web/SVG}{SVG} \cite{SVGMozilla}, a very flexible text-based standard for describing images that can be compressed and modified very easily without loss of quality.
