...
\begin{itemize}
	\item Visualizaion with python from the lecture "Computational Physics" by Prof. Dr. A. Bäcker,
...
--dataStructure TEXT in {array,combined,tree}=combined
data structure for storing the solution
-m,--maxBagSize INT=-1      max size of a bag on the gpu
