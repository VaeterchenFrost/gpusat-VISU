...
If we want to merge more than two images we can specify the parameters in a list.
The list can be of different length for each parameter - if it is exhausted the last parameter in the list will be repeatedly used until all images are joined.
% perspective 
