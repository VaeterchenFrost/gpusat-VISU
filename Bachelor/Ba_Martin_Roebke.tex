...
The development of techniques for dynamic programming for various problems or platforms that have not yet been implemented can in principle be theoretically demonstrated. However, there can be errors in actual implementations that are not always easy to pin down. As there were no tailored tools for this yet, one should be created and integrated into existing tools with a minimum of additional effort.
...
And current advancements in dynamic programming on tree-decompositions itself can be found in \cite{dpdbpadl2020} and \cite{taminghightw}.
%\cite{ELVIZ}
%
...
%============== TD ====================================================
\subsubsection{Dynamic Programming on Tree Decompositions}
