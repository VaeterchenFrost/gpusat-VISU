...
MSO queries on tree decomposable structures are computable with linear delay \cite{MSOQueriesGuillaume}. There are many "easy" problems on tree decomposable graphs \cite{ARNBORG1991308}.
