...
\begin{figure}[H]
	...
	\caption{Wheel graph with 8 vertices and edges from listing \ref{lst:wheelgraph}.}
...
\end{itemize}
can be seen. \\
To further visualize the progress of the algorithm in the results one could use the possibility to specify multiple values for all the transformation parameters \textit{centerpad}, \textit{v\_bottom}, \textit{v\_top} and \textit{scale2} and elevate the second image with the values for v\_bottom = [1, 0.85, 0.7, 0.55, 0.4]. This is done in images 
%svg_join(['TDStep', 'graph'],
%'Archive/WheelGraph7',
...
\begin{figure}[H]
	...
	\caption{Joining results from section \ref{sec:minvc} at step 1. Also shifting the second graphic to $60\%$ height of the first image and scaling with scale2 = 1.5 .}
...
\begin{figure}[H]
	...
	\caption{Joining results from section \ref{sec:minvc} at step 2. Also shifting the second graphic to $60\%$ height of the first image and scaling with scale2 = 1.5 .}
...
\begin{figure}[H]
	...
	\caption{Joining results from section \ref{sec:minvc} at step 3. Also shifting the second graphic to $60\%$ height of the first image and scaling with scale2 = 1.5 .}
...
\begin{figure}[H]
	...
	\caption{Joining results from section \ref{sec:minvc} at step 4. Also shifting the second graphic to $60\%$ height of the first image and scaling with scale2 = 1.5 .}
...
\begin{figure}[H]
	...
	\caption{Joining results from section \ref{sec:minvc} at step 5. Also shifting the second graphic to $60\%$ height of the first image and scaling with scale2 = 1.5 .}
...
\lstinputlisting[caption={Edges for example \ref{fig:wheelgraph}}, label={lst:wheelgraph}]{images/WheelGraph7/wheelgraph7.col}
%==============================================================================
%============== BIBLIOGRAPHY ==================================================
%==============================================================================
\newpage
