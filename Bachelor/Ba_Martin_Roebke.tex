...
\begin{figure}[H]
	...
	\begin{tabularx}{\textwidth}{ l X X }
		step 1: &\includegraphics{images/DA4SAT/results/IncidenceGraphStep1.pdf} & \includegraphics{images/DA4SAT/results/PrimalGraphStep1.pdf} \\ 
		step 2: &\includegraphics{images/DA4SAT/results/IncidenceGraphStep2.pdf} & \includegraphics{images/DA4SAT/results/PrimalGraphStep2.pdf} \\ 
		&Visualization for the incidence graph including information of the sat formula & 
		\centering Visualization for the primal graph \\
	\end{tabularx}
