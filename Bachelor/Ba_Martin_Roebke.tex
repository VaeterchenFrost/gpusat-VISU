...
\begin{enumerate}
	\item Create a tree decomposition $\sc{T}$ of the graph.
	\item Apply dynamic programming for each bag in bottom up order
	\begin{itemize}
		\item[a)] visit the next node \textit{n} of the tree decomposition,
