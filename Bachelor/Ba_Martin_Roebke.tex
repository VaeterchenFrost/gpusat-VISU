...
with the clause-set $\{c_{1}=\{-a,-b,-c,-d\},c_{2}=\{b,c,d\},c_{3}=\{g\}\}$ will create the dual graph \ref{fig:disconnected123}. This happens with no pre-processing and if the variable g is only included in the unit $c_{3}$.
...
The functionality is placed in the file \textit{svgjoin.py} and called with the specifications given in the optional dictionary \textbf{svgjoin} within the JsonAPI.
