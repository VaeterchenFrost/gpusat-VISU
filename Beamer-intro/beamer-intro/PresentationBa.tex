...
\documentclass[c,8pt,xcolor...,x11names, handout]{beamer}
...
%		as they involve bit fiddling
		\medskip
		\item Practical debug output quickly becomes very large (GB)
...
\subsection{gpusat2}
\begin{frame}
	\frametitle{gpusat2 - Solving on GPU}
%	=> Dynamic programming Grafiken / Verlaufsschema Kurz erklären -> Beweise dazu sind aufwändig und recht spezialisiert / 
	...
	\end{minipage}
	\begin{figure}
		\includegraphics[height=0.3\textheight]{images/DADPonGPU.png}
	\end{figure}
...
\section{Challenge}
\begin{frame}
	\frametitle{Diff. debug information and problem types}
	\medskip
...
\begin{frame}
	...
	\begin{figure}
		...
		\caption*{{ dpdb????}\footnote{"Solving \#SAT on the GPU with Dynamic Programming and OpenCL",\\ Diploma Markus Zisser 2018 Technische Universit\"at Wien, p.33}
		{}}
		\label{fig:dualda43}
	\end{figure}
...
\begin{frame}
	...
	%%2014), pp. 105--120.
	 ...
	 Nicht speziell Angeschaut / Format aus Solvern extrahiert - kann trotzdem sehr generisch sein (dpdb speziell)
\end{frame}
...
%		https://data-science-blog.com/blog/2015/07/20/3d-visualisierung-von-graphen/
	...
	\begin{itemize}
		\item Bottlenecks of different architectures
		\item Preselection of interesting areas/data to visualize
...
\begin{frame}
	\frametitle{Summary}
		...
		\begin{itemize}
			...
			\item compiles simple SVG graphics
		\end{itemize}
			
	
	it integrates well into both used systems and provides a starting point for future investigations into
	implementations of dynamic programming on tree
	decompositions and bug spotting and fixing by using visualizations.
